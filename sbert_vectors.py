...
with open(r'/data/stops.txt', 'r') as f:
    stops = f.read().split('\n')
...
doc_sentences = [[w for w in doc_sentences[doc] if len(w) > 1 and w not in stops] for doc in range(len(doc_sentences))]
...
joblib.dump(newsgroups_data, "data/20ng/data_20ng_SBERT_embedding.pkl")
